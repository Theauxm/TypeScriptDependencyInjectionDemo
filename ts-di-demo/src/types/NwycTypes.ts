/**
 * NWYC API TypeScript definitions generated from OpenAPI 3.0.3 specification
 */
...
export interface GetMessageFormParams {
  clear_address?: boolean;
  ajax?: boolean;
...
export interface GetLegislatorSearchParams {
  search?: string;
  state?: string;
  legislature?: string;
}

export interface GetEmailSettingsParams {
  e?: string;
  feml?: boolean;
}

export interface GetAuthenticateParams {
  redirect?: string;
  quick?: boolean;
}
